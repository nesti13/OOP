...
namespace Lab4
{
    public partial class Form1 : Form
    {
        ...
        private void AddNewItem_Click(object sender, EventArgs e)
        {
            ...
            // создаем
            Video HighVideo = videoCreator.Create(builder);
            //создаем объект и передаем с помощью абстрактной фабрики процессор, видео и стратегии озу
            ...
            NewComputer test = new NewComputer(computer.Proc, computer.Video, computer.TypeOZU);
            computer = new Computer(computer.Proc, computer.Video, computer.TypeOZU);
            Computers.Add(computer);
            FieldForProc.Text += computer.ToString() + Environment.NewLine + Environment.NewLine;
            FieldForProc.Text += test.ToString() + Environment.NewLine + Environment.NewLine;
        }
