...
namespace Lab2
{
    ...
    public class Computer
    {
       ...
       [Required]
        ...
        public IOZUType OZU { get; set; }

        public Computer(string computertype, Proc proc, Video video, int sizeOZU, string typeOZU, int sizeHD, string typeHD, IOZUType ozu)
        {
        ...
        public string Comp()
        {
            return $"Работает с процессором {Proc}";
        }
    }
}
